      ...
      <div className="bg-white dark:bg-gray-950">
        <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
          <div className="w-full flex justify-between h-14 items-center">
            <div className="h-full flex items-center gap-x-4 text-gray-700 dark:text-gray-500">
              <a href="tel:" className="flex gap-1 text-sm" rel="noreferer">
                ...
                <span className="hidden sm:flex">+212 674494786</span>
              </a>
              <a
                href="mailto:"
              ...
              >
                ...
                <span className="hidden sm:flex">Karmel@gmail.com</span>
              </a>
            </div>
            <div className="flex items-center gap-x-2.5 -mx-2 text-gray-700 dark:text-gray-500 children:p-2 children:border children:border-x-gray-200 dark:children:border-gray-800 children:bg-gray-100 dark:children:bg-gray-900 children:rounded-md">
              <Link
                href="#facebook"
